<div class="card card_custom" data-index="preferences">
        ...
        <div class="table-responsive">
            <form action="{{ route('error-lens.config.store') }}" method="post">
                ...
                <div class="form-group mb-3">
                    ...
                    <select class="form-control severityLevel w-100" multiple="multiple" name="severityLevel[]">
                        <option value="4xx"
                            {{ @$configurations['error_preferences.severityLevel'] && in_array('4xx', old('severityLevel', @$configurations['error_preferences.severityLevel'] ?? [])) ? 'selected' : '' }}>
                            4xx Client Error
                        </option>
                        <option value="5xx"
                            {{ @$configurations['error_preferences.severityLevel'] && in_array('5xx', old('severityLevel', @$configurations['error_preferences.severityLevel'] ?? [])) ? 'selected' : '' }}>
                            5xx Server Error
                        </option>
                    </select>
                ...
                <div class="d-flex  justify-content-between  align-items-top">
                    <div class="form-group mb-3">
                        <div class="form-check form-switch">
                            <label class="form-check-label" for="haventProductionEnv">Haven't Production
                                Environment?</label>
                            <input class="form-check-input" type="checkbox" role="switch" name="haventProductionEnv"
                                id="haventProductionEnv"
                    ...
                    <div class="form-group mb-3 customEnvName">
                        ...
                        <input type="text" class="form-control" placeholder="staging"
                            {{ old('customEnvName', @$configurations['error_preferences.customEnvName']) }}
                            name="customEnvName"
                            value="{{ old('customEnvName', @$configurations['error_preferences.customEnvName'] ?? config('app.env')) }}">
                        <small class="text-danger">
                ...
                <div class="d-flex  justify-content-between  align-items-top">
                    <div class="form-group mb-3">
                        <div class="form-check form-switch">
                            ...
                            <input class="form-check-input" type="checkbox" role="switch" name="autoDeleteLog"
                                id="autoDeleteLog"
                    ...
                    <div class="form-group mb-3 logDeleteAfterDays">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" placeholder="30"
                                {{ old('logDeleteAfterDays', @$configurations['error_preferences.logDeleteAfterDays']) }}
                                name="logDeleteAfterDays"
                                value="{{ old('logDeleteAfterDays', @$configurations['error_preferences.logDeleteAfterDays']) }}">
                ...
                <div class="d-flex  justify-content-between  align-items-top">
                    <div class="form-group mb-3">
                        <div class="form-check form-switch">
                            <label class="form-check-label" for="showRelatedErrors">Show Related
                                Error Logs</label>
                            <input class="form-check-input" type="checkbox" role="switch" name="showRelatedErrors"
                                id="showRelatedErrors"
                    ...
                    <div class="form-group mb-3 showRelatedErrorsOfDays">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" placeholder="30" aria-label="30"
                                aria-describedby="showRelatedErrorsOfDays" name="showRelatedErrorsOfDays"
                                value="{{ old('showRelatedErrorsOfDays', @$configurations['error_preferences.showRelatedErrorsOfDays']) }}">
                            <span class="input-group-text bg-primary text-white"
                                id="showRelatedErrorsOfDays">Days</span>
                        </div>
                        <small class="text-danger">
                ...
                <div class="form-group mb-3">
                    ...
                    <select class="form-control skipErrorCodesInput w-100" multiple="multiple"
                        name="skipErrorCodes[]">
                ...
                <div class="mt-3 mb-4">
                    <b class="text-danger">[Note: The system will, by default, skip the 400, 401, 403, 404, 406, 409,
                        413, and 422 status codes, whether configured or not.]</b>
                </div>
