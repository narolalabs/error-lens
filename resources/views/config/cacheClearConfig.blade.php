<div class="card card_custom" data-index="cacheClearConfig">
    ...
    <div class="custom_table p-4">
        <div class="table-responsive">
            <form action="{{ route('error-lens.config.cache-clear') }}" method="post">
                ...
                <div class="mt-3">
                    <b class="text-danger">[Note: After making any configuration changes, please clear the cache to
                        ensure that the changes take effect.]</b>
                </div>
            </form>
        </div>
    </div>
