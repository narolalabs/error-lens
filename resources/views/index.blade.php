                ...
                <div class="row mb-3">
                    ...
                    <div class="col-lg-3">
                        <div class="card card_block">
                            ...
                            <div class="card-body d-flex justify-content-between align-items-end py-2">
                                <a href="{{ route($currentRouteName, ['view' => 'yesterday']) }}"
                    ...
                    <div class="col-lg-3">
                        <div class="card card_block">
                            ...
                            <div class="card-body d-flex justify-content-between align-items-end py-2">
                                <a href="{{ route($currentRouteName, ['view' => 'last-month']) }}"
                                    class="text-decoration-none">
                                    View
                                    <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512">
                                        <path
                    ...
                    <div class="col-lg-3">
                        <div class="card card_block">
                            ...
                            <div class="card-body d-flex justify-content-between align-items-end py-2">
                                <a href="{{ route($currentRouteName, ['view' => 'current-year']) }}"
                                    class="text-decoration-none">
                                    View
                                    <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512">
                                        <path
                ...
                <div class="col-12">
                    <div class="card card_custom">
                        <div class="card-header d-flex align-items-center justify-content-between">
                            <h4>{{ $activeError }}</h4>
                            <div>
                                <form action="{{ route('error-lens.archived') }}" method="POST" id="archivedErrorForm"
                                    class="d-none">
                                    @csrf
                                    @method('POST')
                                ...
                                <form action="{{ route('error-lens.archived.delete-selected') }}" method="POST"
                                    id="archivedErrorDeleteForm" class="d-none">
                                    @csrf
                                    @method('POST')
                                    ...
                                    <div class="col-md-6 col-lg-8 col-xl-5 ms-auto">
                                        <div class="input-group mb-3">
                                            <input type="text" class="form-control" placeholder="Search error"
                                                ...
                                                name="searchErrorInput" id="searchErrorInput"
                                                value="{{ request()->searchErrorInput }}">
                                            <button class="btn btn-primary d-inline-flex align-items-center"
                                                type="submit" id="searchErrorButton">
            ...
            function selectAllCheckbox() {
                ...
                singleCheckboxes.forEach(function(singleCheckbox) {
                    singleCheckbox.addEventListener('change', function(event) {
                        selectAll.checked = !document.querySelectorAll(
                            '.singleCheckbox:not(:checked)').length;

                        (isArchivedPage) ? hideShowArchivedErrorDeleteFrom():
